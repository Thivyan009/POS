            ...
            {items.length === 0 ? (
              ...
              <div className="grid gap-4 sm:gap-6 lg:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {items.map((item) => (
                  <div
                    key={item.id}
                    className={`group relative flex flex-col rounded-xl sm:rounded-2xl overflow-hidden bg-card border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${
                      !item.available
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-1 p-3 sm:p-4 lg:p-5">
                      <h3 className="font-semibold text-sm sm:text-base lg:text-lg text-foreground mb-2 line-clamp-2 group-hover:text-primary transition-colors">
                        {item.name}
                      </h3>
                      <div className="mt-auto pt-2">
                        <Separator className="mb-2 sm:mb-3 opacity-50" />
